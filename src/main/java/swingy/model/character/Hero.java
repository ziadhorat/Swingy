...
public class Hero extends Character {
    ...
    public String toString() {
        ...
        sb.append("Name(Class): ").append(name).append(" (").append(heroClass).append(")").append("\n");
        sb.append("Level(XP): ").append(level).append(" (").append(experience).append(")").append("\n");
        sb.append("Attack/Defense: ").append(attack).append("/").append(defense).append("\n");
